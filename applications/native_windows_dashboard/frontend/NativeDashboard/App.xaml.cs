...
public partial class App : System.Windows.Application
{
    ...
    private static string ResolveAppRoot()
    {
        ...
        while (current is not null)
        {
            ...
            var repoStyleAppRoot = Path.Combine(current.FullName, "applications", "native_windows_dashboard", "backend");
            if (Directory.Exists(repoStyleAppRoot))
            {
                return Path.Combine(current.FullName, "applications", "native_windows_dashboard");
            }
