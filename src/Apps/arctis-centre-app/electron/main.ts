...
function detectWorkspaceRoot(): string {
  const seeds = [process.cwd(), app.getAppPath()];
...
function migrateLegacyState(): void {
  ...
  if (fs.existsSync(oldStateCache)) {
    ...
    const legacyCandidates = [
      path.resolve(app.getAppPath(), "..", "..", "APIs", "arctis_nova_api", "tools", "tray_dashboard_state.json"),
      path.resolve(app.getAppPath(), "..", "tools", "tray_dashboard_state.json"),
      path.resolve(app.getAppPath(), "..", "..", "..", "src", "APIs", "arctis_nova_api", "tools", "tray_dashboard_state.json"),
    ];
