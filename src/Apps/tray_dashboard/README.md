...
- The app persists last known state to `src/APIs/arctis_nova_api/tools/tray_dashboard_state.json` and uses it as fallback when live data is temporarily unavailable.
